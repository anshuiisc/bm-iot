...
public class BloomFilterCheck extends AbstractTask {
...
//		return b ? Float.valueOf(0) :  Float.valueOf(1);
		// set parent to have the actual predictions
		return (Float) super.setLastResult(b ? Float.valueOf(1) :  Float.valueOf(0));
	}
